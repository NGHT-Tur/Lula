...
import { Text,View, Alert, SafeAreaView, FlatList, StyleSheet, Image, ImageBackground, Dimensions, StatusBar} from "react-native";
export default class MeteorScreen extends Component{
    ...
    render(){
        ...
        <FlatList keyExtractor={this.keyExtractor} data={meteoritos} renderItem={this.renderItem} horizontal={true}/>
        </View>
        )
    }}
}
