...
import { Text,View, ImageBackground, SafeAreaView,StyleSheet,StatusBar, Alert, Image, ViewPagerAndroidBase} from "react-native";
...
export default class IssLocationScreen extends Component{
    ...
    getIssLocation=()=>{
        axios.get("https://api.wheretheiss.at/v1/satellites/25544").then(response=>{this.setState({location:response.data})}).catch(error=>{Alert.alert(error.message)})
    }
    render(){
        ...
        return(
            ...
            <Image style={styles.IssIcon} source={require("../assets/iss_icon.png")}/>
            </Marker>
            </MapView>
            </View>
